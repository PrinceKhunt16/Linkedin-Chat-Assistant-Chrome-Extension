...
const Content = () => {
  ...
  const [groqApiKey, setGroqApiKey] = useState('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');
  ...
  const generateMessageFromContext = async () => {
    try {
      ...
      const prompt = `
        You are a professional LinkedIn messaging assistant. Based on the provided context and personalized context, generate a concise and professional LinkedIn message. Ensure the message is friendly yet professional, grammatically correct, and engaging. Maintain the intended meaning while improving clarity.

        Follow these key principles while crafting the message:
          - Start with Context (if needed): Mention why you're reaching out or continuing the conversation.
          - Be Concise & Clear: Keep the message short and to the point.
          - Professional but Friendly Tone: Balance formality with a natural, engaging tone.
          - Value-Driven Approach: Show how the conversation benefits both sides.
          - Use Greetings Smartly: Keep it only if necessary, based on the conversation flow. If the user includes a greeting, keep it. If not, avoid adding one unless it naturally fits.
  ...
  return (
    <div className="chat-assistant-container" style={{ fontFamily: "Proza Libre, sans-serif" }}>
      <h3 style={{ fontFamily: "Proza Libre, sans-serif" }}>LinkedIn Chat Assistant</h3>
        ...
        <div className="use-case-container">
          ...
          {nextMessage && (
            <div className="message-container">
              <p style={{ fontFamily: "Proza Libre, sans-serif" }}>{nextMessage || 'Next message will appear here...'}</p>
              {nextMessage && (
                <button
      ...
      {selectedUseCase === 'create-chat' && (
        <div className="use-case-container">
          ...
          {generatedMessage && (
            <div className="message-container">
              <p style={{ fontFamily: "Proza Libre, sans-serif" }}>{generatedMessage}</p>
              <button
                className="copy-button"
      ...
      {selectedUseCase === 'grammer-mistakes' && (
        <div className="use-case-container">
          ...
          {avoidedGrammerMistakeMessage && (
            <div className="message-container">
              <p style={{ fontFamily: "Proza Libre, sans-serif" }}>{avoidedGrammerMistakeMessage}</p>
              <button
                className="copy-button"
          ...
          <div className="message-template-container">
            <div className="use-case-container">
              ...
              {responseMessageTemplate && (
                <div className="message-container">
                  <p style={{ fontFamily: "Proza Libre, sans-serif" }}>{responseMessageTemplate}</p>
                  <button
                    className="copy-button"
        ...
        <div className="storage-container">
          ...
          {Object.keys(savedData).length > 0 && (
            <div className="saved-data-container">
              <h4 className='saved-prompt-title' style={{ fontFamily: "Proza Libre, sans-serif" }}>Saved Messages:</h4>
              {Object.entries(savedData).map(([key, value]) => (
                <div key={key} className='storage-item'>
                  <h2 className='saved-item-key' style={{ fontFamily: "Proza Libre, sans-serif" }}>{key}</h2>
